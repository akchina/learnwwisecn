...
本站是 Audiokinetc 为中文用户设立的 Wwise 学习资源仓库，主要提供官方用户文档和[认证课程](https://www.audiokinetic.com/learn/certification/)之外的短篇图文教程。视需要不定期添加新内容和更新现有内容。

本仓库中的文档一般采用 Markdown 格式，可在 Web 浏览器中在线阅读，也可用浏览器另存为 PDF 文档。可以通过 GitHub 的版本控制报告追踪现有文档的内容变化。`master`分支代表 Wwise 最新稳定版本的情况，若版本之间有变则会创建相应分支。
